#!/usr/bin/env node
/**
 * Zealthy App — Codebase Assessment Report Generator
 * Run: node scripts/codebase-assessment-report.js
 * Output: reports/CODEBASE_ASSESSMENT.md (and stdout)
 */

const fs = require("fs");
const path = require("path");

const REPORT = `# Zealthy App — Codebase Assessment Report
...
const OUT_FILE = path.join(OUT_DIR, "CODEBASE_ASSESSMENT.md");
